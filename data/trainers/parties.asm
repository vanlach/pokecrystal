...
FalknerGroup:
	...
	db  7, HOOTHOOT,   PECK, GROWL, NO_MOVE, NO_MOVE
	db  7, DODUO,      PECK, QUICK_ATTACK, GROWL, NO_MOVE
	db  8, GLIGAR,     POISON_STING, SAND_ATTACK, FURY_CUTTER, NO_MOVE
	db  8, FARFETCH_D, PECK, LEER, FURY_ATTACK, NO_MOVE
	db -1 ; end
...
WhitneyGroup:
	...
	db 17, DUNSPARCE,  DEFENSE_CURL, DIG, HEADBUTT, ATTRACT
	db 16, SMEARGLE,   SKETCH, SKETCH, NO_MOVE, NO_MOVE
	db 18, JIGGLYPUFF, SING, DEFENSE_CURL, POUND, MUD_SLAP
	db 20, AIPOM,      SCRATCH, TAIL_WHIP, FURY_SWIPES, SAND_ATTACK
	db -1 ; end
...
BugsyGroup:
	...
	db 14, SPINARAK,   POISON_STING, STRING_SHOT, CONSTRICT, NO_MOVE
	db 15, YANMA,      TACKLE, DOUBLE_TEAM, LEECH_LIFE, NO_MOVE
	db 15, PINECO,     TACKLE, PROTECT, DEFENSE_CURL, NO_MOVE
...
MortyGroup:
	...
	db 23, MISDREAVUS, SPITE, CONFUSE_RAY, PSYWAVE, MEAN_LOOK
	db 21, MISDREAVUS, SPITE, CURSE, PSYWAVE, DOUBLE_TEAM
	db -1 ; end
...
PryceGroup:
	...
	db 28, CLOYSTER,   WITHDRAW, AURORA_BEAM, SUPERSONIC, ICY_WIND
	db 30, JYNX,       POWDER_SNOW, LOVELY_KISS, ATTRACT, ICE_PUNCH
	db 31, LAPRAS,     MIST, BODY_SLAM, AURORA_BEAM, RAIN_DANCE
	db -1 ; end
...
JasmineGroup:
	...
	db 35, SKARMORY,   SAND_ATTACK, STEEL_WING, DOUBLE_TEAM, DRILL_PECK
	db 33, FORRETRESS, RAPID_SPIN, TAKE_DOWN, BIDE, SELFDESTRUCT
	db 33, SCIZOR,     METAL_CLAW, AGILITY, QUICK_ATTACK, DOUBLE_TEAM
	db -1 ; end
...
ChuckGroup:
	...
	db 27, HITMONCHAN, AGILITY, COMET_PUNCH, ICE_PUNCH, DETECT
	db 27, HITMONLEE,  MEDITATE, JUMP_KICK, HI_JUMP_KICK, DETECT
	db 25, HERACROSS,  HORN_ATTACK, LEER, ROCK_SMASH, ENDURE
	db 27, HITMONTOP,  FOCUS_ENERGY, RAPID_SPIN, ROLLING_KICK, DETECT
	db -1 ; end
...
ClairGroup:
	...
	db 35, DRATINI,    THUNDER_WAVE, WRAP, SLAM, DRAGONBREATH
	db 40, KINGDRA,    LEER, SURF, DRAGONBREATH, AGILITY
	db -1 ; end
...
WillGroup:
	...
	db 42, MR__MIME,   BARRIER, PSYCHIC_M, LIGHT_SCREEN, HYPNOSIS
	db -1 ; end
...
BrunoGroup:
	...
	db 45, HERACROSS,  COUNTER, FURY_CUTTER, ENDURE, MEGAHORN
	db -1 ; end
...
KarenGroup:
	...
	db 47, TYRANITAR,  SANDSTORM, THRASH, CRUNCH, EARTHQUAKE
	db -1 ; end
...
KogaGroup:
	...
	db 43, WEEZING,    SWAGGER, SLUDGE_BOMB, TOXIC, EXPLOSION
	db -1 ; end
...
BrockGroup:
	...
	db 42, LARVITAR,   HEADBUTT, DIG, PROTECT, HIDDEN_POWER
	db -1 ; end
...
MistyGroup:
	...
	db 45, VAPOREON,   HYDRO_PUMP, ICE_BEAM, SWAGGER, HAZE
	db 54, POLITOED,   HYPNOSIS, PSYCHIC_M, TOXIC, WATERFALL
	db -1 ; end
...
LtSurgeGroup:
	...
	db 43, LANTURN,    THUNDER, DOUBLE_TEAM, FLASH, SURF
	db -1 ; end
...
ErikaGroup:
	...
	db 45, VILEPLUME,  POISONPOWDER, SLUDGE_BOMB, GIGA_DRAIN, SUNNY_DAY
	db 43, PARASECT,   SPORE, SOLARBEAM, SLASH, GROWTH
	db -1 ; end
...
JanineGroup:
	...
	db 38, MUK,        MINIMIZE, SLUDGE_BOMB, DISABLE, GIGA_DRAIN
	db -1 ; end
...
SabrinaGroup:
	...
	db 48, HYPNO,      HYPNOSIS, NIGHTMARE, PSYCHIC_M, MEDITATE
	db 47, SLOWKING,   PSYCHIC_M, SWAGGER, SURF, PROTECT
	db 45, WOBBUFFET,  COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db -1 ; end
...
BlaineGroup:
	...
	db 47, FLAREON,    FIRE_BLAST, SHADOW_BALL, SAND_ATTACK, FIRE_SPIN
	db 47, NINETALES,  FLAMETHROWER, CONFUSE_RAY, IRON_TAIL, ATTRACT
	db 50, CHARIZARD,  SLASH, SMOKESCREEN, FIRE_BLAST, FIRE_PUNCH
	db -1 ; end
