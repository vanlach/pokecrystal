...
MapGroup_Cerulean:
	...
	map CeruleanCave1F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_DARK_CAVE, 1, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCave2F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_DARK_CAVE, 1, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB1F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_DARK_CAVE, 1, PALETTE_NITE, FISHGROUP_GYARADOS
