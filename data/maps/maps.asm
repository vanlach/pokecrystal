...
MapGroup_Cinnabar:
	...
	map ArticunoChamber, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterMuseum, TILESET_FACILITY, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Custom:
	map CeruleanCave1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCave2F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map MewGarden, TILESET_FOREST, ROUTE, LANDMARK_SILVER_CAVE, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_NONE
;	map SafariZoneCenter, TILESET_JOHTO, ROUTE, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SAFARI_ZONE
;	map SafariZoneEast, TILESET_JOHTO, ROUTE, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SAFARI_ZONE
;	map SafariZoneNorth, TILESET_JOHTO, ROUTE, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SAFARI_ZONE
;	map SafariZoneWest, TILESET_JOHTO, ROUTE, MUSIC_VIRIDIAN_CITY, FLASE, PALETTE_AUTO, FISHGROUP_SAFARI_ZONE
