...
MapGroup_Cinnabar:
	...
	map ArticunoChamber, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterMuseum, TILESET_FACILITY, INDOOR, PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Custom:
	map CeruleanCave1F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCave2F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map CeruleanCaveB1F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_GYARADOS
	map MewGarden, TILESET_FOREST, ROUTE, SILVER_CAVE, MUSIC_NONE, FALSE, PALETTE_DAY, FISHGROUP_GYARADOS
