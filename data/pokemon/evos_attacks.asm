...
;    * db EVOLVE_HOLDING, held item, species
...
KadabraEvosAttacks:
	db EVOLVE_HOLDING, CALCIUM, ALAKAZAM
	db 0 ; no more evolutions
	db 1, TELEPORT
	db 1, KINESIS
	db 1, CONFUSION
...
MachokeEvosAttacks:
	db EVOLVE_HOLDING, PROTEIN, MACHAMP
	db 0 ; no more evolutions
	db 1, LOW_KICK
	db 1, LEER
	db 1, FOCUS_ENERGY
...
HaunterEvosAttacks:
	db EVOLVE_HOLDING, CARBOS, GENGAR
	db 0 ; no more evolutions
	db 1, HYPNOSIS
	db 1, LICK
	db 1, SPITE
