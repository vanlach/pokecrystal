...
ArticunoChamber_MapEvents:
	...
	db 1 ; object events
	object_event  4,  2, SPRITE_HO_OH, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ArticunoChamberArticuno, EVENT_ARTICUNO_CHAMBER_ARTICUNO
