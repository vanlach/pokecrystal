...
; ???
; Custom Events
	const EVENT_ROUTE_29_HIDDEN_LUCKY_EGG
	const EVENT_GOT_JOHTO_STARTERS_FROM_ELM
	const EVENT_GOT_KANTO_STARTERS_FROM_OAK
	const EVENT_ROUTE_42_RAIKOU
	const EVENT_FOUGHT_RAIKOU
	const EVENT_ROUTE_37_ENTEI
	const EVENT_FOUGHT_ENTEI
	const EVENT_GOT_FOSSIL_POKEMON
	const EVENT_PEWTER_CITY_MUSEUM_SCIENTIST
	const EVENT_ROUTE_10_NORTH_ZAPDOS
	const EVENT_FOUGHT_ZAPDOS
	const EVENT_VICTORY_ROAD_MOLTRES
	const EVENT_FOUGHT_MOLTRES
	const EVENT_ARTICUNO_CHAMBER_ARTICUNO
	...
	const EVENT_MEW_GARDEN_MEW
	const EVENT_FOUGHT_MEW
	const EVENT_UNLOCKED_RARE_ITEM_SELLER
	const EVENT_BEAT_BLACKBELT_AARON
	const EVENT_BEAT_BLACKBELT_MIKE
	const EVENT_BEAT_BLACKBELT_HIDEKI
	const EVENT_BEAT_BLACKBELT_HITOSHI
	const EVENT_FIGHTING_DOJO_HITMONCHAN
	const EVENT_FIGHTING_DOJO_HITMONLEE
	const EVENT_12A
	const EVENT_12B
	const EVENT_12C
	const EVENT_12D
